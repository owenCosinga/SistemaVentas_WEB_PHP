...
//este codigo nos sirve para que el usuario no omita el login y se logee de acuerdo a su cuenta
//con eso se evita que usuarios entren al aplicativo por medio de la url
ob_start();
session_start();
